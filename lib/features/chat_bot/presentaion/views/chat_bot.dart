...
class ChatbotService {
  ...
  Future<void> initialize() async {
    ...
    final siText1 = '''
أنت مساعد ذكاء اصطناعي متخصص في طب و علاج الفم و الأسنان، واسمك  Dr. Smile، ومهمتك تقديم المساعدة لأي شخص يحتاجك في مجالك فقط.
اسمك هو Dr.Smile ,لما تعرضة او تذكره اذكره بنفس الشكل دا بالانجليزي
...
''';
    log(siText1);
    final systemInstruction = Content('system', [TextPart(siText1)]);
